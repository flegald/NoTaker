export class API {
  ...
  getUserSelf(token) {
    return new Promise((resolve, reject) => {
      ...
      var body = null;
      this.hitInternal(endpoint, method, body, headers)
        .then(resp => {
          resolve(resp);
        })
        .catch(resp => {
  ...
  getUserCompletedNotes(token) {
    return new Promise((resolve, reject) => {
      var endpoint = "/user/notes/completed/";
      var method = "GET";
      var headers = {
        Authorization: `JWT ${token}`
      };
  ...
  deleteExistingNoteRequest(token, pk) {
    return new Promise((resolve, reject) => {
      ...
      this.hitInternal(endpoint, method, null, headers)
        .then(resp => {
          return resp;
        })
        .then(resp => {
